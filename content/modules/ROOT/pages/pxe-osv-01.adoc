...
In this scenario, we will be install Portworx Enterprise on an existing OpenShift cluster, as well as creating a new default StorageClass for virtual machines.
